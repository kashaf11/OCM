...
public class MechanicBlockFragment extends Fragment {

    private DatabaseReference mechanicRef, userRefDetails;
        ...
        mechanicRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot s : snapshot.getChildren()) {
                    ...
                    userRefDetails = FirebaseDatabase.getInstance().getReference("Mechanic").child(key);
                    userRefDetails.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (status.equalsIgnoreCase("blocked") || status.equalsIgnoreCase("rejected")
                                ...
                                MechanicAccountAdapter = new MechanicAccountAdapter(mechanicList, new IClickListener() {
                                    ...
                                    public void onItemClicked(int position) {
                                        BlockMechanicDetailFragment blockMechanicDetailFragment = new BlockMechanicDetailFragment();
                                        ...
                                        args.putString("phoneNo", mechanicList.get(position).getPhoneNo());
                                        blockMechanicDetailFragment.setArguments(args);
                                        getFragmentManager().beginTransaction()
                                                .replace(R.id.container, blockMechanicDetailFragment)
                                                .commit();
                                    }
                                });
